    ...
    <>
      ...
      <div className="bg-[#111111] relative overflow-hidden px-6 lg:px-10 py-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-[0.6rem] tracking-[0.28em] uppercase text-[#1a2535] font-medium">Reverse Engineering · CAD Modelling</span>
          ...
          <h1 className="font-display text-[clamp(2.2rem,4vw,3.6rem)] font-medium text-white leading-[1.15] max-w-[640px]">
            Case Study —<br />Project Gamma
          </h1>
          <p className="text-white/60 text-[0.95rem] leading-relaxed max-w-[480px] mt-5">Recreating and improving a legacy component</p>
        </div>
      </div>
      ...
      <section className="bg-white py-24 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <p className="text-[#5a6880] text-[0.92rem] leading-relaxed mb-8">A client needed to continue production of a critical legacy component for which all original documentation had been lost. The only reference was a worn physical sample. The goal was to reverse engineer the part and produce a parametric CAD model suitable for modern manufacture.</p>
            <div>
              <p className="text-[0.6rem] tracking-[0.22em] uppercase text-[#1a2535] font-medium mb-4">Services Used</p>
              <div className="flex flex-wrap gap-2">
                <span className="text-[0.68rem] tracking-[0.1em] uppercase bg-[#111111]/8 text-[#1a2535] px-3 py-1.5 rounded-lg font-medium">Reverse Engineering</span>
      ...
      <section className="bg-[#f4f6f9] py-24 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-[#5a6880] text-[0.92rem] leading-relaxed">We used precision measurement and 3D scanning to capture the existing geometry accurately. Rather than recreating the worn sample as-is, we analysed the design intent behind each feature and reconstructed a clean parametric model — incorporating several geometry and tolerance improvements identified during the process.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#111111] py-24 px-6 lg:px-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
          <div>
            ...
            <p className="text-white/65 text-[0.92rem] leading-relaxed mb-10">The client received a fully documented CAD package with updated tolerances, material specifications, and manufacturing notes. The improved component subsequently outperformed the original in durability testing — extending service life and reducing maintenance frequency.</p>

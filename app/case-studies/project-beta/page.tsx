    ...
    <>
      ...
      <div className="bg-[#111111] relative overflow-hidden px-6 lg:px-10 py-20">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-[0.6rem] tracking-[0.28em] uppercase text-[#1a2535] font-medium">Product Engineering · Tool Design</span>
          ...
          <h1 className="font-display text-[clamp(2.2rem,4vw,3.6rem)] font-medium text-white leading-[1.15] max-w-[640px]">
            Case Study —<br />Project Beta
          </h1>
          <p className="text-white/60 text-[0.95rem] leading-relaxed max-w-[480px] mt-5">Precision tooling redesign for high-volume manufacture</p>
        </div>
      </div>
      ...
      <section className="bg-white py-24 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            <p className="text-[#5a6880] text-[0.92rem] leading-relaxed mb-8">A manufacturer needed to scale production of an existing component but their legacy tooling was causing unacceptable rejection rates and cycle time overruns. The challenge was to redesign both the component and the tooling to improve quality while reducing per-unit cost.</p>
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="text-[0.68rem] tracking-[0.1em] uppercase bg-[#111111]/8 text-[#1a2535] px-3 py-1.5 rounded-lg font-medium">Tool & Die Design</span>
      ...
      <section className="bg-[#f4f6f9] py-24 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-[#5a6880] text-[0.92rem] leading-relaxed">We conducted a thorough DFM audit of the original component, identifying geometry that was contributing to moulding defects. The redesigned part maintained full functional compatibility while introducing features specifically optimised for the injection moulding process. New tooling was designed in parallel, with mould flow analysis validating gating and cooling decisions.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#111111] py-24 px-6 lg:px-10 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
          <div>
            ...
            <p className="text-white/65 text-[0.92rem] leading-relaxed mb-10">The redesigned tooling delivered a dramatic reduction in rejection rate and a measurable improvement in cycle time. The client recovered their investment in new tooling within the first production run through combined material and labour savings.</p>
